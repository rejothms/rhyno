...
export const styles = StyleSheet.create({
    inputView: {
        flex: 5, width: horizontalScale(271), alignItems:"center",alignSelf:"center"
    },
    headerView: {
        fontSize: moderateScale(20), color: "#FFFFFF", fontWeight: "600", lineHeight: moderateScale(24.5), paddingBottom: moderateScale(20),marginTop:10,fontFamily:"Inter-Regular"
    },
    forgotPassword: {
