...
export const styles = StyleSheet.create({
    ...
    headerView: {
        fontSize: moderateScale(20), color: "white", fontWeight: "600", lineHeight: moderateScale(24.5), paddingBottom: moderateScale(20),fontFamily:"Inter-Regular"
    },
    forgotPassword: {
        fontSize: 11, color: "#6F7076", fontWeight: "400", lineHeight: moderateScale(13.75), alignSelf: "flex-end"
    },
    errorText: {
        color: "#DB626C", fontWeight: "400", fontSize: moderateScale(11), lineHeight: moderateScale(13.75)
    },
